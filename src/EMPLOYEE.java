...
public class EMPLOYEE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(553, 479));
    ...
    try
        {
            ...
            ps.setString(1,jTextField10.getText());
              ...
              ps.setLong(5,Long.parseLong(jTextField4.getText()));
        ...
        {
            JOptionPane.showMessageDialog(null,"ERROR WHILE ADDING" + e);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
        String query_d="SELECT EMP_ID from employee";
        stmt=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
        rs=stmt.executeQuery(query_d);
        while(rs.next())
        {
        if(rs.getString("EMP_ID").equals(jTextField10.getText()))
        {
            rs.deleteRow();
        ...
        {
             JOptionPane.showMessageDialog(null, "EMPLOYEE ID NOT FOUND IN THE DATABASE TRY AGAIN");
             break;
        }
        }
        }catch(Exception es)
...
System.exit(0); 
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        setVisible(false);
        emp_information obj_emp=new emp_information();
        obj_emp.setVisible(true);
                // TODO add your handling code here:
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
setVisible(false);
emp_modify obj_m=new emp_modify();
obj_m.setVisible(true);// TODO add your handling code here:
